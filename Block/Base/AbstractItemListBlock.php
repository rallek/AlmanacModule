...
use RK\AlmanacModule\Block\Form\Type\ItemListBlockType;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties = [])
    {
        ...
        if (!$this->hasPermission('RKAlmanacModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return '';
        }
        ...
        // create query
        $orderBy = $this->get('rk_almanac_module.model_helper')->resolveSortParameter($objectType, $properties['sorting']);
        ...
        if (in_array($objectType, $this->categorisableObjectTypes)) {
            if ($featureActivationHelper->isEnabled(FeatureActivationHelper::CATEGORIES, $properties['objectType'])) {
                $categoryHelper = $this->get('rk_almanac_module.category_helper');
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('RKAlmanacModule items');
        }
        ...
        $templateParameters = $this->get('rk_almanac_module.controller_helper')->addTemplateParameters($properties['objectType'], $templateParameters, 'block', []);
    ...
    public function getFormOptions()
    {
        ...
        return [
            ...
            'category_helper' => $this->get('rk_almanac_module.category_helper'),
            'feature_activation_helper' => $this->get('rk_almanac_module.feature_activation_helper')
        ];
    }
    ...
    {
        return '@RKAlmanacModule/Block/itemlist_modify.html.twig';
    }
