...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from almanac app';
     *     $event->getRequest()->attributes->set('RKAlmanacModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('RKAlmanacModule_test');`
     *     now `$testMessage` should be: `'Hello from almanac app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('almanac App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
