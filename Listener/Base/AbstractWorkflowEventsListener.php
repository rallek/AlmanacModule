...
use RK\AlmanacModule\Helper\NotificationHelper;
...
abstract class AbstractWorkflowEventsListener implements EventSubscriberInterface
{
    ...
    public function onGuard(GuardEvent $event)
    {
        ...
        $hasApproval = in_array($objectType, ['date']);
        ...
        switch ($transitionName) {
            ...
            case 'demote':
                ...
                break;
            case 'delete':
                $permissionLevel = in_array($objectType, ['date']) ? ACCESS_EDIT : ACCESS_DELETE;
                break;
        }
    
        if (!$this->permissionApi->hasPermission('RKAlmanacModule:' . ucfirst($objectType) . ':', $entity->getKey() . '::', $permissionLevel)) {
    ...
    public function onEnter(Event $event)
    {
        ...
        if (in_array($entity->get_objectType(), ['date'])) {
