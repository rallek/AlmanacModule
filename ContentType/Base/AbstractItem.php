...
abstract class AbstractItem extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('RKAlmanacModule detail view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display or link a single RKAlmanacModule object.');
    }
    ...
    public function display()
    {
        ...
        $controllerReference = new ControllerReference('RKAlmanacModule:External:display', $this->getDisplayArguments(), ['template' => $this->customTemplate]);
