...
namespace RK\AlmanacModule\HookProvider\Base;
 ...
 */
abstract class AbstractDateUiHooksProvider implements HookProviderInterface
{
    use ServiceIdTrait;
    ...
    {
        return $this->translator->__('Date ui hooks provider');
    }
    ...
    {
        return 'provider.rkalmanacmodule.ui_hooks.dates';
    }
    ...
    {
        return 'RK\AlmanacModule\Entity\HookAssignmentEntity';
    }
    ...
    protected function selectAssignedEntities(Hook $hook)
    {
        ...
        $entities = $this->entityFactory->getRepository('date')->selectByIdList($assignedIds);
    ...
    protected function renderDisplayHookResponse(Hook $hook, $context)
    {
        ...
        $template = '@RKAlmanacModule/Date/includeDisplayItemListMany.html.twig';
