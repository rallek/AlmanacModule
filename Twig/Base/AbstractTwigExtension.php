...
namespace RK\AlmanacModule\Twig\Base;
...
use RK\AlmanacModule\Helper\EntityDisplayHelper;
...
abstract class AbstractTwigExtension extends Twig_Extension
{
    ...
    {
        return [
            new \Twig_SimpleFunction('rkalmanacmodule_moderationObjects', [$this, 'getModerationObjects']),
            new \Twig_SimpleFunction('rkalmanacmodule_objectTypeSelector', [$this, 'getObjectTypeSelector']),
            new \Twig_SimpleFunction('rkalmanacmodule_templateSelector', [$this, 'getTemplateSelector'])
        ];
    }
    ...
    {
        return [
            new \Twig_SimpleFilter('rkalmanacmodule_fileSize', [$this, 'getFileSize'], ['is_safe' => ['html']]),
            new \Twig_SimpleFilter('rkalmanacmodule_listEntry', [$this, 'getListEntry']),
            new \Twig_SimpleFilter('rkalmanacmodule_formattedTitle', [$this, 'getFormattedEntityTitle']),
            new \Twig_SimpleFilter('rkalmanacmodule_objectState', [$this, 'getObjectState'], ['is_safe' => ['html']])
        ];
    }
    
    /**
     * The rkalmanacmodule_objectState filter displays the name of a given object's workflow state.
     * Examples:
     *    {{ item.workflowState|rkalmanacmodule_objectState }}        {# with visual feedback #}
     *    {{ item.workflowState|rkalmanacmodule_objectState(false) }} {# no ui feedback #}
     *
    ...
    /**
     * The rkalmanacmodule_fileSize filter displays the size of a given file in a readable way.
     * Example:
     *     {{ 12345|rkalmanacmodule_fileSize }}
     *
    ...
    /**
     * The rkalmanacmodule_listEntry filter displays the name
     * or names for a given list item.
     * Example:
     *     {{ entity.listField|rkalmanacmodule_listEntry('entityName', 'fieldName') }}
     *
    ...
    /**
     * The rkalmanacmodule_moderationObjects function determines the amount of unapproved objects.
    ...
    /**
     * The rkalmanacmodule_objectTypeSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    /**
     * The rkalmanacmodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    /**
     * The rkalmanacmodule_formattedTitle filter outputs a formatted title for a given entity.
     * Example:
     *     {{ myPost|rkalmanacmodule_formattedTitle }}
     *
