...
namespace RK\AlmanacModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            $jsAssetBag->add($assetHelper->resolve('@RKAlmanacModule:js/RKAlmanacModule.js'));
            $jsAssetBag->add($assetHelper->resolve('@RKAlmanacModule:js/RKAlmanacModule.ItemSelector.js'));
        ...
        if (!$permissionApi->hasPermission('RKAlmanacModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }

        $categorisableObjectTypes = ['date'];
        $catIds = [];
        ...
        $view = Zikula_View::getInstance('RKAlmanacModule', false);
    ...
    public function decode(Zikula_Form_View $view)
    {
        ...
        $this->objectType = $request->request->get('RKAlmanacModule_objecttype', 'date');
