...
namespace RK\AlmanacModule\Form\Type\Finder\Base;
...
/**
 * Date finder form type base class.
 */
abstract class AbstractDateFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addCategoriesField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('categories', CategoriesType::class, [
            ...
            'entityCategoryClass' => 'RK\AlmanacModule\Entity\\' . ucfirst($options['object_type']) . 'CategoryEntity',
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the date') => 1,
                $this->__('Absolute url to the date') => 2,
                $this->__('ID of date') => 3,
                $this->__('Relative link to the image') => 6,
                $this->__('Image') => 7,
                $this->__('Image with relative link to the date') => 8,
                $this->__('Image with absolute url to the date') => 9
            ],
    ...
    {
        return 'rkalmanacmodule_datefinder';
    }
