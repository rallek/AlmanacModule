...
namespace RK\AlmanacModule\Form\Type\QuickNavigation\Base;
...
/**
 * Date quick navigation form type base class.
 */
abstract class AbstractDateQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addCategoriesField(FormBuilderInterface $builder, array $options = [])
    {
        ...
        $builder->add('categories', CategoriesType::class, [
            ...
            'entityCategoryClass' => 'RK\AlmanacModule\Entity\\' . ucfirst($objectType) . 'CategoryEntity',
    ...
    {
        $listEntries = $this->listHelper->getEntries('date', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'rkalmanacmodule_datequicknav';
    }
}
