...
namespace RK\AlmanacModule\Entity\Repository\Base;
 ...
 *
 * This is the base repository class for date entities.
 */
abstract class AbstractDateRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'RK\AlmanacModule\Entity\DateEntity';

    /**
     * @var string The default sorting field/expression
     */
    protected $defaultSortingField = 'dateTitle';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'RKAlmanacModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'dates', 'userid' => $userId];
     ...
     *
     * @return array|dateEntity Retrieved data array or dateEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved dateEntity instances
     */
    ...
    public function getListQueryBuilder($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if ((!$useJoins || !$slimMode) && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('date', $qb);
        }
    ...
    public function selectSearch($fragment = '', array $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('date', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numDates';
        if (true === $useJoins) {
    ...
    public function selectCount($where = '', $useJoins = false, array $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('date', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of dates to exclude (optional)
     *
     * @return boolean Result of this check, true if the given date does not already exist
     */
