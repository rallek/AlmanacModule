...
use RK\AlmanacModule\Entity\Factory\EntityInitialiser;
...
abstract class AbstractEntityFactory
{
    ...
    {
        $entityClass = 'RK\\AlmanacModule\\Entity\\' . ucfirst($objectType) . 'Entity';
     ...
     *
     * @return RK\AlmanacModule\Entity\dateEntity The newly created entity instance
     */
    public function createDate()
    {
        $entityClass = 'RK\\AlmanacModule\\Entity\\DateEntity';

        $entity = new $entityClass();

        $this->entityInitialiser->initDate($entity);
    ...
    public function getIdField($objectType = '')
    {
        ...
        $entityClass = 'RKAlmanacModule:' . ucfirst($objectType) . 'Entity';
