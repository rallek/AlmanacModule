...
<div style="margin-left: 80px">
    <div{* class="form-group"*}>
        <p>{gt text='Please select your item here. You can resort the dropdown list and reduce it\'s entries by applying filters. On the right side you will see a preview of the selected entry.' domain='rkalmanacmodule'}</p>
        {rkalmanacmoduleItemSelector id='id' group='data' objectType=$objectType}
    </div>
    ...
    <div{* class="form-group"*}>
        ...
        <div class="col-sm-9">
            ...
            <span class="help-block">{gt text='Example' domain='rkalmanacmodule'}: <em>displaySpecial.html.twig</em></span>
            <span class="help-block">{gt text='Needs to be located in the "External/YourEntity/" directory.' domain='rkalmanacmodule'}</span>
        </div>
    </div>
</div>
