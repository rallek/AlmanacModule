...
function rKAlmanacToday(format) {
...
function rKAlmanacReadDate(val, includeTime) {
...
function rKAlmanacValidateNoSpace(val) {
    var valStr;
...
function rKAlmanacValidateUploadExtension(val, elem) {
...
function rKAlmanacValidateDateRangeDate(val) {
    var cmpVal, cmpVal2, result;
    cmpVal = rKAlmanacReadDate(jQuery("[id$='startDate']").val(), true);
    cmpVal2 = rKAlmanacReadDate(jQuery("[id$='endDate']").val(), true);
 ...
 */
function rKAlmanacExecuteCustomValidationConstraints(objectType, currentEntityId) {
    jQuery('.validate-upload').each(function () {
        if (!rKAlmanacValidateUploadExtension(jQuery(this).val(), jQuery(this))) {
    ...
    jQuery('.validate-daterange-date').each(function () {
        if (typeof jQuery(this).attr('id') != 'undefined') {
            if (jQuery(this).prop('tagName') == 'DIV') {
                if (!rKAlmanacValidateDateRangeDate()) {
