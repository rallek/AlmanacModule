...
abstract class AbstractViewHelper
{
    ...
    public function getViewTemplate($type, $func, $isAdmin = false)
    {
        ...
        $template = '@RKAlmanacModule/' . ucfirst($type) . '/' . ($isAdmin ? 'Admin/' : '') . $func;
    ...
    {
        $extensions = [];
        $hasAdminAccess = $this->permissionApi->hasPermission('RKAlmanacModule:' . ucfirst($type) . ':', '::', ACCESS_ADMIN);
        if ($func == 'view') {
            if ($hasAdminAccess) {
                $extensions = ['rss', 'atom', 'json'];
            } else {
                $extensions = ['rss', 'atom'];
            }
        } elseif ($func == 'display') {
