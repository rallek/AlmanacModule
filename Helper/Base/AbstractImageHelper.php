    ...
    public function getCustomRuntimeOptions($objectType = '', $fieldName = '', $contextName = '', $context = '', array $args = [])
    {
        $options = [
            'thumbnail' => [
                ...
                'mode'      => $this->variableApi->get('RKAlmanacModule', 'thumbnailMode' . ucfirst($objectType) . ucfirst($fieldName), ImageInterface::THUMBNAIL_INSET),
        ...
        if ($contextName == $this->name . '_relateditem') {
            ...
            if (in_array($args['action'], ['view', 'display', 'edit'])) {
                ...
                $options['thumbnail']['size'] = [
                    $this->variableApi->get('RKAlmanacModule', 'thumbnailWidth' . $fieldSuffix, $defaultWidth),
                    $this->variableApi->get('RKAlmanacModule', 'thumbnailHeight' . $fieldSuffix, $defaultHeight)
                ];
            }
        }
