...
abstract class AbstractListEntriesHelper
{
    ...
    public function hasMultipleSelection($objectType, $fieldName)
    {
        ...
        switch ($objectType) {
            ...
            case 'appSettings':
                switch ($fieldName) {
                    case 'thumbnailModeDateDateImage':
                        $result = false;
                        break;
    ...
    public function getEntries($objectType, $fieldName)
    {
        ...
        switch ($objectType) {
            case 'date':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForDate();
                        break;
                }
                break;
            case 'appSettings':
                switch ($fieldName) {
                    case 'thumbnailModeDateDateImage':
                        $entries = $this->getThumbnailModeDateDateImageEntriesForAppSettings();
                        break;
                    case 'enabledFinderTypes':
     ...
     * @return array Array with desired list entries
     */
    public function getWorkflowStateEntriesForDate()
    {
        $states = [];
        $states[] = [
            'value'   => 'deferred',
    ...
    /**
     * Get 'thumbnail mode date date image' list entries.
     *
     * @return array Array with desired list entries
     */
    public function getThumbnailModeDateDateImageEntriesForAppSettings()
    {
        $states = [];
        $states[] = [
            'value'   => 'inset',
